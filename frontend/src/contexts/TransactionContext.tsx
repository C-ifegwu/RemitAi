...
export const TransactionProvider: React.FC<TransactionProviderProps> = ({ children }) => {
  ...
  const initiateOnRamp = async (userId: string, fiatAmount: number, fiatCurrency: string, _provider: string) => {
    setLoading(true);
    setError(null);
  ...
  // Mark unused parameters with underscore
  const initiateOffRamp = async (_userId: string, usdcAmount: number, targetCurrency: string, recipientDetails: any, provider: string) => {
    setLoading(true);
    setError(null);
  ...
  // Mark unused parameters with underscore
  const assessTransactionRisk = async (userId: string, _commandText: string, amount: number, _recipientId: string) => {
    setLoading(true);
    setError(null);
