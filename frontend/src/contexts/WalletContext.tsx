...
export const WalletProvider: React.FC<WalletProviderProps> = ({ children }) => {
  ...
  const confirmRecoveryPhraseSaved = async (_userId: string) => {
    setLoading(true);
    setError(null);
  ...
  const linkBiometric = async (_userId: string, _voicePrintId: string) => {
    setLoading(true);
    setError(null);
  ...
  const recoverWithPassphrase = async (_userId: string, _passphraseWords: string[]) => {
    setLoading(true);
    setError(null);
  ...
  const recoverWithBiometric = async (_userId: string, _voiceVerificationToken: string) => {
    setLoading(true);
    setError(null);
